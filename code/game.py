...
class Agent:
    ...
    def registerInitialState(self, state):
        # Compute the path to the goal using the search algorithm specified by the `fn` parameter
        # Store the path in the `actions` attribute
        self.actions = self.searchFunction(state)
